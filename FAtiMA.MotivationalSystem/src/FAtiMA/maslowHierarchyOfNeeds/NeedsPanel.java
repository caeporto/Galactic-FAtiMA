...
public class NeedsPanel extends AgentDisplayPanel {
	...
	public NeedsPanel(MotivationalComponent ms) {
		...
		_needs.add(aux.getPhysiologicalPanel());
		_needs.add(aux.getSafetyPanel());
		_needs.add(aux.getRelationshipsPanel());
		_needs.add(aux.getEsteemPanel());
		_needs.add(aux.getRealizationPanel());
