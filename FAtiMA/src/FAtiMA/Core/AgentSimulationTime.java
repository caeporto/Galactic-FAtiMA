 ...
 * 
 * History: 
 * Jo�o Dias: 2/Jul/2006 - File created
 * Jo�o Dias: 10/07/2006 - the class is now serializable
 * Jo�o Dias: 17/07/2006 - added the SaveState and LoadState methods
 * Jo�o Dias: 29/08/2006 - Solved small bug in LoadState method
...
public class AgentSimulationTime implements Serializable {
	 ...
	 * each simulation round so that time is properly updated.
	 */
	public void Tick()
	{
