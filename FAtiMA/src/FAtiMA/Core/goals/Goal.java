 ...
 * Jo�o Dias: 12/07/2006 - the class is now Clonable
 * Jo�o Dias: 17/07/2006 - the Methods decreaseImportanceOfFailure and DecreaseImportanceOfSuccess
 * 						   receive one additional parameter (the amount to decrease)
 * Jo�o Dias: 17/07/2006 - Important change in the calculation of ImportanceOfSuccess and
 ...
 * Jo�o Dias: 28/09/2006 - Refactoring: Renamed the method GetImportanceOfSucess to
 * 						   GetImportanceOfSuccess (you can see why)
 * Jo�o Dias: 22/12/2006 - After some reconsideration, we do need a fixed part and a dinamic
 ...
 * Jo�o Dias: 18/02/2007 - Added the methods GetActivationEvent, GetFailureEvent, GetSuccessEvent
 */
