...
public class ConfigurationManager {
	...
	public static String getRolePath()
	{
		if(VersionChecker.runningOnAndroid())
		{
			return AgentCore.ROLE_PATH_ANDROID;
		}
		else
		{
			return AgentCore.ROLE_PATH;
		}
	}
	...
	public static boolean getAgentLoad(){
		String agentLoad = getOptionalConfigurationValue(AGENT_LOAD);
		if(agentLoad!=null){
	...
	public static boolean getMemoryLoad(){
		String memoryLoad = getOptionalConfigurationValue(MEMORY_LOAD);
		if(memoryLoad!=null){
