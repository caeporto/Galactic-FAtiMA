/** 
 * IGroundable.java - Interface that specifies methods appliable to classes that have WFNames,
 * 					  and thus can use ground methods
 *  
 ...
 * 
 * History: 
 * João Dias: 12/07/2006 - File created
 **/
 ...
 * @author João Dias
 *
 * Interface that specifies methods appliable to classes that can be grounded,
