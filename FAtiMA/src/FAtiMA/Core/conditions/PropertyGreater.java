/**
 * PropertyGreater.java - Class that represents a specific property test, in this case checks
 * if one property is bigger than another value (only works with numeric properties)
 *  
...
public class PropertyGreater extends PropertyCondition {
	...
	public void Print() {
		super.Print();
		AgentLogger.GetInstance().logAndPrint(" Operator: Greater");
	}
