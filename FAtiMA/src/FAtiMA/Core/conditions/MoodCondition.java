 ...
 * 
 * History: 
 * Jo�o Dias: 09/02/2007 - File created
 */
...
public class MoodCondition extends Condition {
	...
	public MoodCondition(short operator, float value, Symbol tom)
	{
		super(Name.ParseName("mood(" + operator + ")"), tom);
	...
	public static MoodCondition ParseMoodCondition(Attributes attributes) throws InvalidMoodOperatorException, NoMoodOperatorDefinedException
	{
		...
		MoodCondition mc = new MoodCondition(operator,value,tom);
	...
	private String switchOperator(short operator)
	{
		switch(this._operator)
		{
			case operatorEqual:
	...
	{
		return getToM() + " Mood " + switchOperator(_operator) + " " + _value;
	}
}