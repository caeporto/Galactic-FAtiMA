...
public class AppraisalCondition extends PastEventCondition {
	...
	{
		IComponent comp = am.getComponent(MotivationalComponent.NAME);
		if(comp instanceof FAtiMA.motivationalSystem.MotivationalComponent)
		{
			FAtiMA.motivationalSystem.MotivationalComponent motivationalComponent = (FAtiMA.motivationalSystem.MotivationalComponent) comp;
			return motivationalComponent.searchEventsWithAppraisal(am, _subject, _action, _target, _parameters.get(0), desirability);
		}
		else
		{
			FAtiMA.maslowHierarchyOfNeeds.MotivationalComponent motivationalComponent = (FAtiMA.maslowHierarchyOfNeeds.MotivationalComponent) comp;
			return motivationalComponent.searchEventsWithAppraisal(am, _subject, _action, _target, _parameters.get(0), desirability);
		}
